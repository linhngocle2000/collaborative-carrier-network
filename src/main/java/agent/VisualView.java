...
public class VisualView {
   ...
   private ViewPanel createEmbeddedView(Graph graph) {
    ...
    private JPanel createGraphPanel(ViewPanel view) {
        ...
        graphStreamBackPanel.setPreferredSize(new Dimension((int) (550 * scaling), (int) (450 * scaling)));
    ...
    private JPanel createResultPanel() {
        ...
        subpanel.setPreferredSize(new Dimension((int) (550 * scaling), (int) (40 * scaling)));
