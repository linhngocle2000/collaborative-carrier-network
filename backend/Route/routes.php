...
$handler->register('init', function ($data)
{
	...
	$queries = [
		...
		"INSERT INTO `Agent`(`Username`, `Name`, `Password`, `MinProfit`, `MaxProfit`, `DepotLat`, `DepotLon`, `PickupBaserate`, `TravelCostPerKM`, `LoadBaserate`, `InternalTravelCostPerKM`) VALUES ('agentC', 'Agent C', '$agentPW', 37,  9, 153, 173, 37, 8, 20, 3)",
